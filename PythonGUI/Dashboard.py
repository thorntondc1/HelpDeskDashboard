...
class AccountDashboard(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, title="University of Central Arkansas Account Tool", pos=(100,150), size=(1250,980))

        self.panel = wx.Panel(self)

        #Enter account username text 
        self.Prompt = wx.StaticText(self.panel, label = "Enter Account Username:", pos = (20,850))
        ...
        #Making buttons 
        self.button1 = wx.Button(self.panel, label = "Unlock", pos = (400,840), size= (90,37))
        self.button2 = wx.Button(self.panel, label = "Reset", pos = (500,840), size=(90,37))
        self.button3 = wx.Button(self.panel, label = "Clear", pos = (600,840), size = (90,37))

        #edit message under textbox
        self.Result = wx.StaticText(self.panel, pos = (190,880))
        font2 = self.Result.GetFont()
        font2.PointSize = 10
        self.Result.SetFont(font2)
        
        #edit textbox
        self.Username = wx.TextCtrl(self.panel, pos = (185,847), size=(197,25))
        font3 = self.Username.GetFont()
        font3.PointSize = 10
        self.Username.SetFont(font3)

        #browser
        self.Browser = wx.html2.WebView.New(self.panel, pos = (20,10), size = (1200,800))
